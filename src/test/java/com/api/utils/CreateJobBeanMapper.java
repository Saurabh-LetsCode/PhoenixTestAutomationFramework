...
public class CreateJobBeanMapper {
    ...
    public static CreateJobPayload mapper (CreateJobBean bean){
        ...
        CreateJobPayload createJobPayload = new CreateJobPayload(mstServiceLocationId,mstPlatformId,mstWarrantyStatusId,oemId,customer,customerAddress,customerProduct,problemList);
